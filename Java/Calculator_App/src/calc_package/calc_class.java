...
public class calc_class implements ActionListener{
	...
	Font myFont = new Font("Seaford",Font.BOLD,35);
	...
	calc_class(){
		...
		textfield.setBounds(45,25,290,50); /*(x,y,w,h)*/
		...
		panel = new JPanel();
		panel.setBounds(45, 100, 290, 290);
